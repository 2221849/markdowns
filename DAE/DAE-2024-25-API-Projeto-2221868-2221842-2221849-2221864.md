...
**EP02.** O **sensor** com o identificador #1 envia os dados lidos. Utilizando o protocolo HTTP, verbo `PUT`, para o endpoint: `/sensors/{sensorId}`
...
**EP03.** O **Cliente** no **Sistema de Apoio ao Cliente** pede os dados de todas as encomendas do utilizando o protocolo HTTP, verbo `GET`, para o endpoint: `/orders/{customerId}`
